      ...
      <div class="container-revenue">
        <div className="label-revenue">
          <button className="next-month">
            <MdOutlineArrowBackIosNew style={{ fontSize: "28px" }} />
          </button>
            ...
            <div class="card-block">
              <div class="rowr align-items-center">
                <div class="col-9">
                  ...
                  <h6 class="text-muted m-b-0">Sold products</h6>
                </div>
                <div class="col-3 text-right">
          ...
          <div class="element-revenue">
            <div class="card-block">
              <div class="rowr align-items-center">
                ...
                <div class="col-3 text-right">
                  <BsCalendar4Week style={{ fontSize: "28px" }} />
                </div>
              </div>
            </div>
            ...
            <div class="card-block">
              <div class="rowr align-items-center">
                <div class="col-9">
                  ...
                  <h6 class="text-muted m-b-0">New products</h6>
                </div>
                <div class="col-3 text-right">
